...
const CompleteProfile = ({route}) => {
  ...
  const AddOutFitType = async () => {
    ...
    //
    form.append('w_country', profile?.country);
    form.append('w_state', profile?.state);
    form.append('w_city', profile?.city);
    form.append('w_mandal', profile?.mandal);
    form.append('w_village', profile?.village);
    ...
    console?.log(form, 'form\n', userToken, `${BaseUrl}/complete-profile`);
  ...
  const onSubmit = () => {
    ...
    else if(profile?.w_village === '') {
      return Snackbar.show({
        text: `Enter Your Work City Name`,
        textColor: 'red',
        numberOfLines: 1,
        backgroundColor: '#fff',
      });
    }
    else if(profile?.w_mandal === '') {
      return Snackbar.show({
        text: `Enter Your Work Local Area`,
        textColor: 'red',
        numberOfLines: 1,
        backgroundColor: '#fff',
      });
    }
    else if(profile?.w_city === '') {
      return Snackbar.show({
        text: `Enter Work Your City`,
        textColor: 'red',
        numberOfLines: 1,
        backgroundColor: '#fff',
      });
    }
    else if(profile?.w_state === '') {
      return Snackbar.show({
        text: `Enter Work Your State`,
        textColor: 'red',
        numberOfLines: 1,
        backgroundColor: '#fff',
      });
    }
    else if(profile?.w_country === '') {
      return Snackbar.show({
        text: `Enter Work Your country`,
        textColor: 'red',
        numberOfLines: 1,
        backgroundColor: '#fff',
      });
    ...
    <View style={{backgroundColor: '#611EBD', flex: 1}}>
      ...
      <View
        ...
        <ScrollView
          ...
          <Heading
            label='Your Street Address or Village'
          />
          ...
          <TextInput
            ...
            placeholder="Your Street Address/Village"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />

          <Heading label={'Your Local Area or Mandal'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, mandal: text})}
            value={profile?.mandal}
            placeholder="Type your Local Area/Mandal"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />
          ...
          <Heading label={'Your City or District'} />
          <TextInput
            style={styles.input}
          ...
          <Heading label={'Your Street Work Address or Village'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, w_village: text})}
            value={profile?.w_village}
            placeholder="Your Work Street Address/Village"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />

          <Heading label={'Your Work Local Area or Mandal'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, w_mandal: text})}
            value={profile?.w_mandal}
            placeholder="Your Work Local Area/Mandal"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />
          ...
          <Heading label={'Your Work City or District'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, w_city: text})}
            value={profile?.w_city}
            placeholder="Your Work City or District"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />


          <Heading label={'Your Work State'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, w_state: text})}
            value={profile?.w_state}
            placeholder="Type Work your State"
            keyboardType="email-address"
            placeholderTextColor={'#8B8A8A'}
          />


          <Heading label={'Your Work Country'} />
          <TextInput
            style={styles.input}
            onChangeText={text => setProfile({...profile, w_country: text})}
            value={profile?.w_country}
            placeholder="Type Work your country"
            placeholderTextColor={'#8B8A8A'}
          />
