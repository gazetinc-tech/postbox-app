...
const EditProfile = ({route}) => {
  ...
  const initialState = {
    ...
    w_country: profile?.w_country ? profile?.w_country : '',
    w_state: profile?.w_state ? profile?.w_state : '',
    w_city: profile?.w_city ? profile?.w_city : '',
    w_mandal: profile?.w_mandal ? profile?.w_mandal : '',
    w_village: profile?.w_village ? profile?.w_village : '',
  };
  ...
  const AddOutFitType = async () => {
    ...
    form.append('w_country', profiles?.w_country);
    form.append('w_state', profiles?.w_state);
    form.append('w_city', profiles?.w_city);
    form.append('w_mandal', profiles?.w_mandal);
    form.append('w_village', profiles?.w_village);
    ...
    <View style={{backgroundColor: '#fff', flex: 1}}>
      ...
      <ScrollView
        ...
        <Text
          ...
          Edit Your Street Address or Village
        </Text>
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, village: text})}
          value={profiles?.village}
          placeholder="Your Street Address or Village"
          keyboardType="email-address"
        />
        ...
        <Text
          ...
          Edit Your Local Area or Mandal
        </Text>
        <TextInput
          style={styles.input}
        ...
        <Text
          ...
          Edit Your Work Street Address or Village
        </Text>
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, w_village: text})}
          value={profiles?.w_village}
          placeholder="Your Work Street Address or Village"
          keyboardType="email-address"
        />
        ...
        <Text
          ...
          Edit Your Work Local Area or Mandal
        </Text>
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, w_mandal: text})}
          value={profiles?.w_mandal}
          placeholder="Type your Work Local Area"
          keyboardType="email-address"
        />
        ...
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, w_city: text})}
          value={profiles?.w_city}
          placeholder="Type your Work City"
          keyboardType="email-address"
        />
        ...
        <Text
          ...
          Edit Your Work State
        </Text>
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, w_state: text})}
          value={profiles?.w_state}
          placeholder="Type your Work City"
          keyboardType="email-address"
        />
        ...
        <Text
          ...
          Edit Your Work Country
        </Text>
        <TextInput
          style={styles.input}
          onChangeText={text => setProfiles({...profiles, w_country: text})}
          value={profiles?.w_country}
          placeholder="Type your Work Country"
          keyboardType="email-address"
        />
